...
bool     __sent_result100 = token.call(bytes4 (sha3("transfer(address,uint256)")), to, amount);
...
function WithdrawToHolder (address    _addr,uint    _wei) public onlyOwner __lock_modifier0 payable {
if (Holders[_addr]>0)
{
