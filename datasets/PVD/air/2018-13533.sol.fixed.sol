...
contract ALUXToken is sGuardPlus,owned,TokenERC20 {
...
function setStatus (bool    isClosedBuy,bool    isClosedSell) public onlyOwner  {
...
function withdraw (uint    amountInWeis) public onlyOwner  {
