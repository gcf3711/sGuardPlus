...
contract Doftcoin is sGuardPlus,BasicToken,owned,doftManaged {
string  public   name;
...
require(_target!=0x0);
balanceOf[_target]=add_uint256(balanceOf[_target], _mintedAmount);
_totalSupply=add_uint256(_totalSupply, _mintedAmount);
