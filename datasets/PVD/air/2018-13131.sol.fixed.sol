...
contract DSPXToken is sGuardPlus,StandardToken {
...
constructor (address    _preSale,address    _team)   {
...
require(value>0);
require(add_uint256(totalSupply, value)<=TOKEN_LIMIT);
balances[holder]=add_uint(balances[holder], value);
totalSupply=add_uint256(totalSupply, value);
...
constructor (address    _team,address    _icoAgent) public  {
require(_team!=address (0));
