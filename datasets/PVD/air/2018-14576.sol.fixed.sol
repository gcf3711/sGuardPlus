...
contract SunContractToken is sGuardPlus,IERC20Token,owned {
...
function transfer (address    _to,uint256    _value)   returns (bool    success){
if (block.number<tokenFrozenUntilBlock)
throw;
if (restrictedAddresses[_to])
throw;
...
if (restrictedAddresses[_to])
throw;
if (add_uint256(balances[_to], _amount)<balances[_to])
throw;
supply=add_uint256(supply, _amount);
