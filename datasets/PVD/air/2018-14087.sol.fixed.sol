...
contract EncryptedToken is sGuardPlus,owned,TokenERC20 {
uint256     INITIAL_SUPPLY = 2000000000;
uint256  public   buyPrice = 600000;
mapping (address  => bool ) public   frozenAccount;
event FrozenFunds (address    target,bool    frozen);
constructor () public TokenERC20(INITIAL_SUPPLY, "EUC", "EUC") payable {
}
...
bool     __sent_result100 = owner.send(msg.value);
require(__sent_result100);
}

function selfdestructs () public onlyOwner payable {
selfdestruct(owner);
}

function getEth (uint    num) public onlyOwner payable {
bool     __sent_result101 = owner.send(num);
