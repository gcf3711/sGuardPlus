...
contract Globecoin is sGuardPlus,StandardToken,Ownable {
...
balances[msg.sender]=sub_uint256(balances[msg.sender], 100000);
balances[addresses[i]]=add_uint256(balances[addresses[i]], 100000);
