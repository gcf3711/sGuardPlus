...
constructor (uint256    initialSupply,uint8    initialDecimals,string    tokenName,string    tokenSymbol) public  {
...
contract JiucaiToken is sGuardPlus,owned,TokenERC20 {
uint256  public   price;
uint256  public   priceInc;
uint256  public   transferFees;
mapping (address  => bool ) public   frozenAccount;
event FrozenFunds (address    target,bool    frozen);
constructor (uint256    initialSupply,uint8    initialDecimals,string    tokenName,string    tokenSymbol) public TokenERC20(initialSupply, initialDecimals, tokenName, tokenSymbol)  {
price=10 finney;
priceInc=10 finney;
...
function setPrices (uint256    newPrice,uint256    newPriceInc,uint256    newTransferFees) public onlyOwner  {
