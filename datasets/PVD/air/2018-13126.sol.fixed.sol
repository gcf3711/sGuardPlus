...
contract SpendToken is sGuardPlus,StandardToken {
...
constructor (address    _presale,address    _team) public  {
...
require(_value>0);
require(add_uint256(totalSupply, _value)<=TOKEN_LIMIT);
balances[_holder]=add_uint(balances[_holder], _value);
totalSupply=add_uint256(totalSupply, _value);
