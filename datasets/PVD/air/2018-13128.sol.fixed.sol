...
function transfer (address    _to,uint    _value) public onlyPayloadSize(mul_uint256(2, 32))  {
uint     codeLength;
bytes    memory empty;
assembly{
...
function transferFrom (address    _from,address    _to,uint    _value) public onlyPayloadSize(mul_uint256(3, 32))  {
require( ! tokensAreFrozen);
