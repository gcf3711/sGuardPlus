...
contract GRX is sGuardPlus,owned {
string  public   name;
...
balanceOf[target]=add_uint256(balanceOf[target], increaseBy);
totalSupply=add_uint256(totalSupply, increaseBy);
...
if (_value==0)
_value=lockedRewardsOf[addr][msg.sender];
