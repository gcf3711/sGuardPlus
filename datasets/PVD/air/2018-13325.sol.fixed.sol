...
contract GrowToken is sGuardPlus {
...
function setBuyOpen (bool    newBuyOpen) public onlyOwner  {
require(buyPrice>0);
buyOpen=newBuyOpen;
}

function setSellOpen (bool    newSellOpen) public onlyOwner  {
require(sellPrice>0);
sellOpen=newSellOpen;
}

function transferEth (uint256    amount) public onlyOwner  {
msg.sender.transfer(mul_uint256(amount, pow_uint256(10, uint256 (18))));
}
