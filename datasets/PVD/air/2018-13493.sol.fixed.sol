...
_value=mul_uint256(_value, (pow_uint256(10, 18)));
...
contract DaddyToken is sGuardPlus,owned,TokenERC20 {
uint8  public   decimals = 18;
...
balanceOf[addresses[i]]=add_uint256(balanceOf[addresses[i]], _value);
...
mintedAmount=mul_uint256(mintedAmount, pow_uint256(10, 18));
