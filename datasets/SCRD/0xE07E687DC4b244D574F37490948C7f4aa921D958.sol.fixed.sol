...
constructor (uint256    _preIcoStartTime,uint256    _preIcoEndTime,uint256    _preIcoHardcap,uint256    _icoStartTime,uint256    _icoEndTime,uint256    _icoHardcap,uint256    _softcap,uint256    _rate,address    _wallet) public  {
...
bool     __sent_result100 = token.transfer(beneficiary, bonusedTokens);
...
bool     __sent_result101 = token.transfer(beneficiary, tokens);
require(__sent_result101);
}

function setPreIcoParameters (uint256    _preIcoStartTime,uint256    _preIcoEndTime,uint256    _preIcoHardcap,uint256    _preIcoMinimumWei) public onlyOwner  {
require( ! isFinalized);
require(_preIcoStartTime<_preIcoEndTime);
require(_preIcoHardcap>0);
preIcoStartTime=_preIcoStartTime;
...
function setIcoParameters (uint256    _icoStartTime,uint256    _icoEndTime,uint256    _icoHardcap,uint256    _icoMinimumWei) public onlyOwner  {
require( ! isFinalized);
require(_icoStartTime<_icoEndTime);
require(_icoHardcap>0);
icoStartTime=_icoStartTime;
...
applauseCashCrowdsale=new ApplauseCashCrowdsale (1516280400, 1516856400, 3000000*TOKEN_DECIMALS_MULTIPLIER, 1517490000, 1519880400, 144000000*TOKEN_DECIMALS_MULTIPLIER, 50000*TOKEN_DECIMALS_MULTIPLIER, 500, multisig);
}
